...
export default function UpdateProduct(props) {
    ...
    const addProduct = (e) => {
        e.preventDefault();
        console.log(image);
        axios.post('http://localhost:3001/api/updateProduct', { productname: productname, discountprice: discountprice, originalprice: originalprice, description: description, image: image, stock: stock, productId: productId }, { withCredentials: true }).then((response) => {
    ...
    return (
        <div className="form-padding">
            ...
            <form className="product-form-container">
                <h2 className="product-form-title">Update Product Details </h2>
                ...
                <div className="product-form-group">
                    <label htmlFor="price" className="product-form-label">Add Stock :</label>
